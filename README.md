<div style="font-family: sans-serif; max-width: 900px; line-height: 1.6; color: #111;">

<h1>Spectral String</h1>
<p><strong>Deterministic acoustic–spectral instruments for continuous excitation and harmonic control.</strong></p>
...
<p>
Spectral String is a family of single- and dual-string instruments that operate as a <strong>physical-to-spectral bridge</strong>.
</p>
<B>Acoustic Independence Principle</b>
<P></P>
Spectral String is a physically complete acoustic instrument.

All sound production is generated by mechanical string excitation and body resonance alone.

The electronic system is optional and functions as:
- spectral analysis layer
- tuning reference system
- gesture interpretation engine

If all electronics are removed, the instrument remains fully playable and musically valid.
<p>
...
<p>
A physical lever provides instantaneous switching between reference systems:
</p>
